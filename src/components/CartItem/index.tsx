        ...
        <ItemDetails>
          ...
          <ActionContainer>
            <InputNumberContainer>
              <InputNumberButton data-testid="cart-minus-btn" type="button" onClick={handleDecreaseButton}>
                <Minus size={14} weight="bold" />
              </InputNumberButton>
              <span data-testid="cart-amount">{item?.amount}</span>
              <InputNumberButton data-testid="cart-plus-btn" type="button" onClick={handleIncreaseButton}>
